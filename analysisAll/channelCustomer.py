...
def industrydataProcessor():
    ...
    countryDate = getCountryName(countryDate)
    ...
    industryDict={}
    industryDict['国外采购商行业统计']=buyerIndustryDate
    industryDict['国内供应商行业统计']=supplierIndustryDate
    industryDict['行业合计']=industryDate
    industryDict['国内供应商地区统计']=areaDate
    industryDict['国外采购商国家统计']=countryDate
    return industryDict
    # out.write('国外采购商行业统计' + '\n')
...
def tradeDataProcessor(dict, year):
    ...
    buyerData = getCountryName(buyerData)

    buyerNumData = buyerTradeNum.copy()
    buyerNumData = getCountryName(buyerNumData)
    ...
    tradeDataDict={}
    tradeDataDict[str(year) + "采购商各国贸易额"]=buyerData
    tradeDataDict[str(year) + "采购商各国订单数"]=buyerNumData
    tradeDataDict[str(year) + "供应商各省贸易额"]=supplierData
    tradeDataDict[str(year) + "供应商各省订单数"]=supplierNumData
...
def doTrage():
    # 2016年
    dict2016 = tradeDataProcessor(tradeInfo(2016), 2016)
    # 2017年
    dict2017 = tradeDataProcessor(tradeInfo(2017), 2017)
    # 2018年
    dict2018 = tradeDataProcessor(tradeInfo(2018), 2018)

    allDict = dict(dict2016, **dict2017)
    allDict = dict(allDict, **dict2018)
    # 贸易总金额
    return allDict

def main():
    # 行业信息处理
    dict1=doChannelCustomer()
    # 贸易额处理
    dict =doTrage()
